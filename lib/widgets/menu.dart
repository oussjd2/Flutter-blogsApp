...
import '../pages/blog_list_screen.dart'; // Import the BlogListScreen
...
class _MenuState extends State<Menu> {
  List<MenuModel> menu = [
    ...
    MenuModel(icon: 'assets/svg/remote.svg', title: "Gestion Blogs "),
    ...
    MenuModel(icon: 'assets/svg/history.svg', title: "Blog List"), // Add blog list menu item
